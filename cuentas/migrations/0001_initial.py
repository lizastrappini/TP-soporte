    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'required': 'Este campo debe ser rellenado'}, max_length=254, unique=True)),
                ('nombre', models.CharField(blank=True, max_length=254)),
                ('apellido', models.CharField(blank=True, max_length=254)),
